...
document.getElementById("events9").onload = getStoredEvents9AM();
document.getElementById("events10").onload = getStoredEvents10AM();
document.getElementById("events11").onload = getStoredEvents11AM();
document.getElementById("events12").onload = getStoredEvents12PM();
document.getElementById("events1").onload = getStoredEvents1PM();
document.getElementById("events2").onload = getStoredEvents2PM();
document.getElementById("events3").onload = getStoredEvents3PM();
document.getElementById("events4").onload = getStoredEvents4PM();
document.getElementById("events5").onload = getStoredEvents5PM();
...
function getStoredEvents9AM() {
    ...
    if (storedEvent9 !== null) {
        document.getElementById("events9").value = storedEvent9; 
    }
}
...
function getStoredEvents10AM() {
    ...
    if (storedEvent10 !== null) {
        document.getElementById("events10").value = storedEvent10; 
    }
}
...
function getStoredEvents11AM() {
    ...
    if (storedEvent11 !== null) {
        document.getElementById("events11").value = storedEvent11; 
    }
}
...
function getStoredEvents12PM() {
    ...
    if (storedEvent12 !== null) {
        document.getElementById("events12").value = storedEvent12; 
    }
}
...
function getStoredEvents1PM() {
    ...
    if (storedEvent1 !== null) {
        document.getElementById("events1").value = storedEvent1; 
    }
}
...
function getStoredEvents2PM() {
    ...
    if (storedEvent2 !== null) {
        document.getElementById("events2").value = storedEvent2; 
    }
}
...
function getStoredEvents3PM() {
    ...
    if (storedEvent3 !== null) {
        document.getElementById("events3").value = storedEvent3; 
    }
}
...
function getStoredEvents4PM() {
    ...
    if (storedEvent4 !== null) {
        document.getElementById("events4").value = storedEvent4; 
    }
}
...
function getStoredEvents5PM() {
    ...
    if (storedEvent5 !== null) {
        document.getElementById("events5").value = storedEvent5; 
    }
}
